    ...
    <FootnotesProvider footnotes={footnotes}>
      <div className="space-y-4">
        ...
        <p>
          ...
          strip of iridescent metal. If it's unlikely that anyone could make a
          pencil, then it is certain that nobody could construct a computer.
          Layers of infrastructure, architecture, algorithms, and software
          represent the collective result of thousands of years of human
          progress—knowledge that cannot possibly be contained by one person.
        </p>
        ...
        <p>
          ...
          of knowledge. But this stability is not a guarantee. Despite our best
        ...
        <p>
          ...
          knowledge needed to run it—completely reliant on, and vulnerable to, a
          handful of knowledge keepers.
        </p>
        ...
        <p>
          ...
          a cold war over AI. Each holds a lever that could move the world.
        </p>
        ...
        <p>
          ...
          society to control human behavior in order to produce more technology.
          He saw it as an unnatural, parasitic force.
        </p>
        ...
        <p>
          ...
          displacing the societal need for education, as knowing <em>how</em> to
          operate technology becomes more important than knowing <em>why</em> it
          works.
        </p>
        ...
        <p>
          ...
          same name. Every generation will have its Luddites as society reshapes
        ...
        <p>
          ...
          fingertips? It's no surprise that many prioritize the cell phone as a
        ...
        <p>
          ...
          their creative potential toward the societal change ahead. It is the
          only way to ensure the prosperity of future generations.
        </p>
        ...
        <p>
          ...
          entrepreneurship, leadership, oration, and first-principles reasoning.
        </p>
