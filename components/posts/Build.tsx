    ...
    <LoadWrapper>
      <div className="space-y-4">
        <div className="my-8 border border-blue-200 bg-blue-50 px-6 py-4 text-blue-700">
          <p>
            This article is out of date and no longer reflects how this website
            is built. I've kept the original article because this website was
            one of the first public things I made, and I was right to be proud
            of it. I've since written about{" "}
        ...
        <p>
          There were sacrifices. But it is an example of what websites could be
          in stark contrast with what they have become.
        </p>

        <H2>Why speed matters</H2>
        <p>
          Reality has no latency. Things <em>feel</em> wrong when there is a
          delay between our actions and their response. Speed is the most
          important aspect of user experience.
        </p>

        <p>
          But as computers have become more powerful, they haven't gotten
          faster. They're bloated.
        </p>
        ...
        <p>
          Frameworks like React address speed by controlling the DOM. At the
          cost of 100KB of JavaScript, wasted CPU cycles, and complexity.
        </p>

        <p>
          Static HTML is the soul of the internet. It is ubiquitous, easy to
          understand, and easy for search engines to crawl. It is the ideal
          format for any website. Just look at{" "}
        ...
        <p>
          While I wasn't as extreme, this website is pretty close. And I love
          it.
        </p>
        ...
        <p>
          ...
          Everything was handwritten. If it didn't improve the user experience,
          it wasn't included.
        </p>
        ...
        <p>
          ...
          logs. I'm not going to invade your privacy with an inconvenient
          script. Or feed more data to our Google overlord.
        </p>
        ...
        <H3>Hugo</H3>
        <p>
          I chose Hugo because of the control and productivity it provides. I
          was able to create a minimal, semantic structure laden with{" "}
          <InlineLink href="https://schema.org/">schema markup</InlineLink>.
        </p>

        <p>
          Hugo's ability to generate and minify assets in any language removed
          my need for build tools. Keeping my codebase uniform, simple, and
          fast.
        </p>
  ...
  event.waitUntil(
    caches.open('cacheName').then(function(cache) {
      cache.addAll(pagesToCache);
        ...
        <p>
          With Hugo's power and shallow learning curve, I was able to complete
          the base of this website in one week.
        </p>

        <H3>Static assets</H3>
        <p>
          I mentioned that I didn't use any web fonts. I lied. I created one
          with <InlineLink href="http://fontello.com/">Fontello</InlineLink> for
          social media icons. Using <InlineCode code="woff2" /> was only 1KB
          larger than SVG icons with better extensibility.
        </p>

        <p>
          Because I handpicked icons, the entire font is only 3.1KB. Compare
          that to FontAwesome's 161KB. Plus another 70-120KB for every
          font-weight you include.
        </p>

        <p>
          The logo is a single path SVG, made on a 16pt grid and minified with
          one decimal precision. The result is 399B.
        </p>

        <p>
          I used Georgia for the body, Helvetica for headings and navigation,
          and Courier for code. These are all{" "}
        ...
        <p>
          I gave special attention to the typography. Using many shades of grey
          to create a subtle balance of contrast. It strives to be easy on the
          eyes while drawing attention to important sections.
        </p>
  ...
  for (var i = 0; i < imgs.length; i++) {
    ...
    if (img.nodeName === 'IMG') {
      ...
      img.dataset.src ? img.style.backgroundImage = 'url(' + img.dataset.src + ')' : null;
        ...
        <p>
          Creating a ServiceWorker was the most complex piece of this website.
          It took me about 1/3<sup>rd</sup> of the total development time, but
        ...
        <p>
          ...
          would have been enough. You might have picked up, I rarely do things
          the easy way.
        </p>
  ...
  event.respondWith(
    caches.open(cacheName).then((cache) => {
      return cache.match(normalizedUrl).then((response) => {
        ...
        <p>
          The pièce de résistance, a cache then update with network policy
          within static HTML. Keeping the homepage fresh.
        </p>
        ...
        <H3>AWS hosting</H3>
        <p>
          This is an S3 bucket served through Cloudfront routed through a
          Route53 domain. It sounds simple but learning AWS is intimidating.
          Their platform is dense and prickly.
        </p>
        ...
        <p>
          SEO and best practices are at 100, and it's a PWA. Accessibility
          scored a 93 because of the light grey used in meta data. If I were to
          add a contrast option, it would be a "perfect" website.
        </p>

        <p>
          Chasing arbitrary numbers is pointless without purpose. This wasn't
          pointless. This website achieves everything I need and does it
          cleanly. The user experience is pristine. The typography is
          delightful. The structure is meaningful.
        </p>
