  ...
  return (
    <FootnotesProvider footnotes={footnotes}>
      <div className="space-y-4">
        ...
        <p>
          In search of this understanding, I went to the source. John McCarthy's
          original paper{" "}
        ...
        <p>
          ...
          before stumbling upon Paul Graham's article{" "}
          <InlineLink href="https://www.paulgraham.com/rootsoflisp.html">
            The Roots of LISP
          </InlineLink>
          . His clarity helped guide me to that elusive sense of understanding.
        </p>
        <p>
          But it wasn't until I wrote this article that I gained a full grasp of
          the language and its power. I'm leaving my steps here for any who have
          gone down a similar path and still struggle to understand.
        </p>
        <p>
          Keeping true to Paul Graham, I implemented this version of LISP in{" "}
          <InlineLink href="http://www.arclanguage.org/tut.txt">Arc</InlineLink>
...
eq[x x]
        ...
        <p>
          ...
          error if not found. While <InlineCode meta="lisp" code="(eq 'x 'x)" />{" "}
          returns <InlineCode meta="lisp" code="t" />. Keep in mind this is
          shorthand for{" "}
          <InlineCode meta="lisp" code="(eq (quote x) (quote x))" />.
        </p>
        <p>
          Inside-out interpretation feels very unnatural because we are trained
          to read left-to-right, even in programming languages. When reading
          expressions such as{" "}
          <InlineCode meta="lisp" code="(outer (inner '(a b)))" /> you might
          expect <InlineCode meta="lisp" code="outer" /> to be evaluated first.
          However, <InlineCode meta="lisp" code="inner" /> will be the first to
          evaluate.
        </p>
        <p>
          Armed with this basic understanding, you're ready for the 5 elementary
          functions necessary for LISP.
        </p>
...
; returns nil
        ...
        <p>
          Checks if two atomic symbols are the same. In Arc, this is written as{" "}
          <InlineCode code="is{:lisp}" />.
        </p>
...
; returns (x a)
        ...
        <p>
          Stands for "contents of the decrement register." It returns everything
...
; returns ((x a) y b)
        ...
        <p>
          These functions form the core of the "universal function" which is the
          ultimate end of this implementation.
        </p>

        <p>
          Because I am implementing this in Arc, I will be moving away from John
          McCarthy's use of = to define functions and{" "}
        ...
        <p>
          ...
          functions with <InlineCode meta="lisp" code="_" /> to avoid conflicts
          with existing functions. Additionally,{" "}
...
; returns (a b c d)
        ...
        <p>
          Creates a list from two expressions. The distinction between this and{" "}
          <InlineCode meta="lisp" code="cons" /> is that{" "}
...
; returns ((x a) (y b) (z c))
        ...
        <p>
          Gets values from key-value pairs, where the first argument is the key
          and the second argument is a list of pairs.
        </p>
...
; returns (c d)
        ...
        <p>
          This is the most surprising and powerful aspect of the language. With
          5 primitives and 12 functions, you have the building blocks to build
          an interpreter.
        </p>
...
(if (_null m) nil
    (cons (_eval  (car m) a)
        ...
        <p>
          ...
          <InlineCode meta="lisp" code="e" /> as the expression to be evaluated
          and <InlineCode meta="lisp" code="a" /> as a list of pairs that will
          be referenced by <InlineCode meta="lisp" code="e" />.
        </p>

        <p>
          If <InlineCode meta="lisp" code="e" /> is atomic{" "}
          <InlineCode meta="lisp" code="_assoc" /> is called to return the value
          that matches the key <InlineCode meta="lisp" code="e" /> in{" "}
...
; returns b
        ...
        <p>
          ...
          <InlineCode meta="lisp" code="_eval" /> checks if the first element of{" "}
          <InlineCode meta="lisp" code="e" /> is one of the elementary
          functions.
        </p>
...
; returns (x a)
        ...
        <p>
          ...
          takes the form <InlineCode meta="lisp" code="(function key)" />, where{" "}
          <InlineCode meta="lisp" code="key" /> is used to get a value from{" "}
          <InlineCode meta="lisp" code="a" /> that will be evaluated by{" "}
...
; returns t
        ...
        <p>
          <InlineCode meta="lisp" code="car" /> and{" "}
          <InlineCode meta="lisp" code="cdr" /> have a very similar structure to{" "}
          <InlineCode meta="lisp" code="atom" /> because only one expression has
          to be evaluated.
        </p>
...
; returns (b c)
        ...
        <p>
          ...
          <InlineCode meta="lisp" code="eq" /> have two expressions that need to
          be evaluated. As such, <InlineCode meta="lisp" code="a" /> needs to
          contain two pairs.
        </p>
...
; returns (a . b)
        ...
        <p>
          ...
          with the format{" "}
          <InlineCode meta="lisp" code="(condition expression)" />. When a true
          condition is found, that expression is evaluated.
        </p>
...
; returns is_atom
        ...
        <p>
          ...
          <InlineCode meta="lisp" code="lambda" /> function defined by the user.
        </p>
...
; returns not_atom
        ...
        <p>
          Note that <InlineCode meta="lisp" code="(quote t)" /> is used here as
          an explicit <InlineCode meta="lisp" code="else" /> condition. Arc
          handles these cases gracefully, but because we are bound to the rules
          of the interpreter we must use this syntax.
        </p>

        <p>
          During evaluation, the above <InlineCode meta="lisp" code="lambda" />{" "}
          expression becomes
        </p>
...
; returns not_atom
        ...
        <p>
          ...
          supplementary <InlineCode meta="lisp" code="_evlis" /> function which
          recursively constructs a list of pairs from{" "}
        ...
        <p>
          <InlineCode meta="lisp" code="label" /> allows functions to be called
...
; returns a
        ...
        <p>
          ...
          in <InlineCode meta="lisp" code="a" /> to be used later. It will also
          begin evaluating the <InlineCode meta="lisp" code="lambda" /> function
          defined by <InlineCode meta="lisp" code="label" />. During evaluation,
...
(_eval (cons f (_appq args)) nil))
        ...
        <p>
          Using this function, the <InlineCode meta="lisp" code="ff" /> function
          can be written as
        </p>
...
(_eval '((label ff (lambda (x)
      ...
      'nil)
        ...
        <p>
          <InlineCode meta="lisp" code="_apply" /> can be used for anything you
          would write using <InlineCode meta="lisp" code="_eval" />. But it is
          useful to first understand <InlineCode meta="lisp" code="_eval" />{" "}
        ...
        <p>
          The ability to define new languages, and monitor their internal state
          makes LISP an excellent language for exploration and experimentation.
        </p>

        <p>
          Gone is the magic of compilation and executables. You can see every
          step of evaluation for yourself. That makes the exercise of stumbling
          through the archaic syntax fulfilling.
        </p>

        <p>
          I don't see myself using LISP in production. However, I will continue
          to use it as a tool for broadening my understanding of low-level
          programming.
        </p>

        <p>
          The next step for me is to understand how to implement a compiler that
          would convert this to machine code. I plan to read{" "}
        ...
        <p>
          ...
          understanding opens a window into the inner workings of all languages.
          That is the purpose of understanding LISP.
        </p>
