...
export default function LessonsOnStartups() {
  return (
    <div className="space-y-4">
      ...
      <p>
        The finish line always feels close, but it never quite arrives. You are
        building something that will evolve and grow. No matter how many
        deadlines you set, hit, or miss—the work remains constant.
      </p>

      <H2>The last 10% takes 90% of your effort</H2>
      <p>
        The closer you get to finishing, the harder it becomes. The beginning of
        a project feels great because there's no resistance. As it grows,
      ...
      <p>
        ...
        reusable blocks of code and compose those blocks into unique patterns. I
        relate this to making music: twelve simple notes can combine into nearly
        infinite arrangements of chords and melodies. Their beauty lies in
        simplicity and harmony. Great code is the same—it's simple enough to
        enable powerful combinations, and expressive enough to handle
        complexity.
      </p>
      ...
      <p>
        ...
        impression defines your brand. It has to be unforgettable. Stay focused
        on the single <em>aha moment</em> you need to create.
      </p>
      ...
      <p>
        ...
        There is no shortcut to doing it well—it may take years. Make sure your
        lifestyle and circumstances support that kind of long-term effort.
      </p>

      <H2>Do it your way</H2>
      <p>
        Surrender to your own way of being and find your optimal flow. Everyone
        works differently, and no book can teach you how to be <em>you</em>. The
        greatest things are created by people relentlessly pursuing their
        interests. Your path is guaranteed to be unique. The important part is
        getting started. Start building. Start learning. Start improving every
        area of your life.
      </p>
