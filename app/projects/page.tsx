  ...
  return (
    <LoadWrapper>
      <div className="space-y-4">
        <H1>Projects</H1>
        <p>
          I've had the pleasure of working on some great projects. I owe most of
          my personal and professional growth to the people I've worked with on
          these teams.
        </p>
        ...
        <Ul>
          ...
          <Li>
            <InlineLink href="/tic-tac-toe/index.html" target="_blank">
              Tic-tac-toe
            </InlineLink>
          </Li>
          <Li>
